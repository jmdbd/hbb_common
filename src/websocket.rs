...
mod tests {
    ...
    fn test_check_ws() {
        ...
        assert_eq!(check_ws("vlanl.com:21115"), "ws://vlanl.com/ws/id");
        assert_eq!(check_ws("vlanl.com:21116"), "ws://vlanl.com/ws/id");
        assert_eq!(check_ws("vlanl.com:21117"), "ws://vlanl.com/ws/relay");
        // set relay-server without port
        Config::set_option("relay-server".to_string(), "127.0.0.1".to_string());
        Config::set_option(
            "api-server".to_string(),
            "https://api.vlanl.com".to_string(),
        );
        assert_eq!(
        ...
        assert_eq!(check_ws("vlanl.com:21115"), "wss://vlanl.com/ws/id");
        assert_eq!(check_ws("vlanl.com:21116"), "wss://vlanl.com/ws/id");
        assert_eq!(
            check_ws("vlanl.com:21117"),
            "wss://vlanl.com/ws/relay"
        );
